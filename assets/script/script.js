...
console.log("Il reddito annuo netto di ".concat(professionista1.name, " ").concat(professionista1.surname, " ammonta a ").concat(professionista1.getRedditoAnnuoNetto(), "\u20AC"));
...
console.log("Il reddito annuo netto di ".concat(artigiano1.name, " ").concat(artigiano1.surname, " ammonta a ").concat(artigiano1.getRedditoAnnuoNetto(), "\u20AC"));
...
console.log("Il reddito annuo netto di ".concat(commerciante1.name, " ").concat(commerciante1.surname, " ammonta a ").concat(commerciante1.getRedditoAnnuoNetto(), "\u20AC"));
